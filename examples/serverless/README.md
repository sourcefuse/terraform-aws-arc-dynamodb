...
This example demonstrates how to create a serverless DynamoDB table optimized for infrequent access patterns using the terraform-aws-arc-dynamodb module.
